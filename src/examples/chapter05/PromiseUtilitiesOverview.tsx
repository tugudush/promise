...
function PromiseUtilitiesOverview() {
  ...
  return (
    <DemoSection>
      ...
      <p>
        JavaScript provides four main Promise utility methods for handling multiple
        promises simultaneously. Each serves different use cases:
      </p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ background: '#e2e8f0' }}>
                  <th style={{ padding: '0.75rem', textAlign: 'left', border: '1px solid #cbd5e1' }}>
                    Method
                  </th>
                  <th style={{ padding: '0.75rem', textAlign: 'left', border: '1px solid #cbd5e1' }}>
                    When It Resolves
              ...
              <tbody>
                <tr>
                  <td style={{ padding: '0.75rem', border: '1px solid #cbd5e1', fontWeight: '600' }}>
                    Promise.all()
                  </td>
      ...
      <ImportantNote>
        ...
        <ul style={{ marginLeft: '1rem', marginTop: '0.5rem' }}>
          <li><strong>Promise.all()</strong>: All-or-nothing approach - fails fast</li>
          <li><strong>Promise.allSettled()</strong>: Always succeeds, returns all results</li>
          <li><strong>Promise.race()</strong>: Winner takes all - first to finish (success or failure)</li>
          <li><strong>Promise.any()</strong>: First success wins - ignores rejections until all fail</li>
        </ul>
      </ImportantNote>
